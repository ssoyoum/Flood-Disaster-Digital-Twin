...
def get_osong_reconstruction() -> dict[str, Any]:
    ...
    return {
        ...
        "intervention": {
            "name": "Intervention: underpass entrance closure",
            "type": "ROAD_CLOSURE",
            "trigger": "Not provided: no validated underpass-depth trigger is connected",
            "trigger_time": inflow_time,
            "trigger_basis": "The closure time is anchored to the observed inflow timestamp for timeline comparison; no sensor threshold is provided.",
            "closure_action": "Close underpass entrances and block new vehicle entry.",
            "estimated_effect": "Operationally blocks new entry; quantitative effect is not calculated.",
...
def get_osong_summary() -> dict[str, Any]:
    ...
    return {
        ...
        "intervention_state": "Observed-inflow closure comparison available",
